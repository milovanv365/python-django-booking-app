"""
Django settings for honduras project.
...
ROOT_URLCONF = 'honduras.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,'service','templates/'), os.path.join(BASE_DIR,'search_app','templates/'), os.path.join(BASE_DIR,'reservation','templates/'),os.path.join(BASE_DIR,'order','templates/'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'reservation.context_processors.counter',
            ],
        },
    },
]

WSGI_APPLICATION = 'honduras.wsgi.application'
